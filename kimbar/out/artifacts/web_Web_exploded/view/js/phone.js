...
function saveUpdatedPhone(index) {
    var countryCode = document.getElementsByClassName('countryCode')[index].innerHTML ;
    var operatorCode = document.getElementsByClassName('operatorCode')[index].innerHTML ;
    var number = document.getElementsByClassName('number')[index].innerHTML ;
    var type = document.getElementsByClassName('phoneType')[index].innerHTML ;
    var commentary = document.getElementsByClassName('phoneCommentary')[index].innerHTML ;
    ...
    var phone = {
        ...
        type : type,
        id : phoneIdAcclumulator[index].toString()
    };
