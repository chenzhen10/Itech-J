...
function saveAttachmentUpdate(index) {
    var name = document.getElementsByClassName('filName')[index].innerHTML;
    var commentary = document.getElementsByClassName('attachmentComment')[index].innerHTML ;

    var attachment = {
        name : name,
        commentary : commentary,
        id : attachmentIdAccumulator[index].toString()
    };
