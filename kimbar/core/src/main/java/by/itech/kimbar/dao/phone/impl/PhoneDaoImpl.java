...
public class PhoneDaoImpl implements PhoneDao {
    ...
    @Override
    public List<Phone> getPhoneByUserId(Integer userId) throws DaoException, SQLException, ClassNotFoundException {
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection c = DriverManager.getConnection("jdbc:mysql://localhost/kim?serverTimezone=UTC","root","root");
    ...
    @Override
    public boolean updatePhone(Integer countryCode, Integer operatorCode, Integer numberCode, Phone.Type type, String commentary, Integer idPhone) throws DaoException {
        Connection c = ConnectionPool.getInstance().getConnection();
