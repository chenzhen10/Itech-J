...
public class UserServiceImpl implements UserService {
    ...
    public boolean updateUser(String name, String surname, String lastName, Date date, Gender gender, String citizenship,
                              ...
                              String country, String city, String street, String house, String numOfFlat, Integer index, String photoPath, int idClient) throws ServiceException {
        UserDao usrDao = provider.getUserDao();
    ...
    @Override
    public String getPaginationUsers(int start, int total) throws ServiceException {
        UserDao usrDao = provider.getUserDao();
